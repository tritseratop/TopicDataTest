	...
	const SubscriberConfig& config) const
{
	...
	case TopicType::DDS_DATA:
		return new DDSDataSubscriber<DDSData>(participant, config);
	case TopicType::DDS_DATA_EX:
		return new DDSDataSubscriber<DDSDataEx>(participant, config);
	case TopicType::DDS_ALARM:
		return new DDSDataSubscriber<DDSAlarm>(participant, config);
	case TopicType::DDS_EX_ALARM:
		return new DDSDataSubscriber<DDSExAlarm>(participant, config);
	default:
