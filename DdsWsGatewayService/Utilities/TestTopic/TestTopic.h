...
#ifndef _FAST_DDS_GENERATED_TESTTOPIC_H_
#define _FAST_DDS_GENERATED_TESTTOPIC_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(TestTopic_SOURCE)
#define TestTopic_DllAPI __declspec( dllexport )
#else
#define TestTopic_DllAPI __declspec( dllimport )
#endif // TestTopic_SOURCE
#else
#define TestTopic_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define TestTopic_DllAPI
#endif // _WIN32
...
public:
     ...
     */
    eProsima_user_DllExport void dispatch_time(
...
private:
    ...
    int64_t m_dispatch_time;
    std::string m_str;
};

#endif // _FAST_DDS_GENERATED_TESTTOPIC_H_